...
//  finalPanel
//
//  Created by Bogdan Barbulescu on 09/01/2017.
//  Copyright © 2017 Appfish. All rights reserved.
//

import UIKit

class CancelViewController_1: UIViewController {
...
let myAlert = UIAlertController(title: "Do you want to cancel booking?", message: alertMessage, preferredStyle: .alert)
        ...
        myAlert.addAction(UIAlertAction(title: "YES", style: .default, handler: { (action:UIAlertAction) in
            self.performSegue(withIdentifier: "cancelCompleted", sender: self)
   }))
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
//let timeConsidered = 86400
//calculate the amount to charge when booking is cancelled
